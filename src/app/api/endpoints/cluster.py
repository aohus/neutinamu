...
async def create_cluster(
    ...
    cluster, photos = await service.create_cluster(job_id=job_id, order_index=order_index, name=name, photo_ids=photo_ids)
...
async def add_photos_to_cluster(
    cluster_id: str,
    payload: ClusterAddPhotosRequest,
    db: AsyncSession = Depends(get_db)
):
    service = ClusterService(db)
